        ...
        <Container>
          <Row className="align-items-center">
            ...
            <Col lg={6} className="hero-image">
              <img src="https://via.placeholder.com/600x400" alt="Resume Builder" className="img-fluid" />
            </Col>
          </Row>
        </Container>
      </section>
          ...
          <Row>
            <Col lg={4} md={6} className="mb-4">
              <Card className="template-card">
                <Card.Img variant="top" src={fresherTemplate} />
                <Card.Body>
            ...
            <Col lg={4} md={6} className="mb-4">
              <Card className="template-card">
                <Card.Img variant="top" src={mbaTemplate} />
                <Card.Body>
            ...
            <Col lg={4} md={6} className="mb-4">
              <Card className="template-card">
                <Card.Img variant="top" src={designerTemplate} />
                <Card.Body>
